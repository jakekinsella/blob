...
* [`src/notes/styles.cljs`](src/notes/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/notes/`](src/notes/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/notes/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `notes` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/notes/config.cljs) defaults to `true` in
...
```clj
(ns notes.example
  (:require [notes.config :as config])
